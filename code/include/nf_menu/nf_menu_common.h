...
typedef struct nf_menu_screen_fn_ptrs
{
    ...
    void (*on_render)(_nf_menu_t *menu_state, ssd1306_t *disp_ptr,
                      void *extra_data);
    void (*on_btn)(_nf_menu_t *menu_state, uint btn, bool repeat,
                   void *extra_data);
...
void draw_edit_item(ssd1306_t *disp_ptr, uint y, bool selected,
                    const char *str);
